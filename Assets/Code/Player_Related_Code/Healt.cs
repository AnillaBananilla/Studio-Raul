...
public class Healt : MonoBehaviour
{
    ...
    public Vector3 damageTextOffset = new Vector3(0, 3f, 0); // Offset para la posición del texto
    ...
    private void ShowDamageText(int damage)
    {
        if (damageTextPrefab != null)
        {
            ...
            Destroy(damageTextInstance, 1f); // Destruir el texto después de 1 segundo
        }
    }
}